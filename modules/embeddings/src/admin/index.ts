  ...
  private registerAdminRoutes() {
    ...
    this.routingManager.route(
      ...
      new ConduitRouteReturnDefinition('GetEmbeddingStatus', {
        ...
        warnings: [ConduitString.Required],
        configCount: ConduitNumber.Required,
        enabledConfigCount: ConduitNumber.Required,
        sourceCount: ConduitNumber.Required,
        readySourceCount: ConduitNumber.Required,
        pendingSourceCount: ConduitNumber.Required,
        failedSourceCount: ConduitNumber.Required,
        disabledSourceCount: ConduitNumber.Required,
        revokedSourceCount: ConduitNumber.Required,
        queryableSourceCount: ConduitNumber.Required,
      }),
    ...
    this.routingManager.route(
      ...
      new ConduitRouteReturnDefinition('ReconcileEmbeddingSource', {
        ...
        warnings: [ConduitString.Required],
        recovered: ConduitNumber.Optional,
        discarded: ConduitNumber.Optional,
      }),
