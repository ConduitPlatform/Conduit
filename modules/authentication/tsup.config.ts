...
// Bundle node-2fa from TS source (dist CJS breaks ESM shims); notp/thirty-two stay external.
const extraExternal = [...bundleConfig.extraDependencies, 'notp', 'thirty-two'];
