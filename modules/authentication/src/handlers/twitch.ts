...
import { TwitchPayload } from './interfaces/twitch/TwitchPayload';
...
export class TwitchHandlers extends AuthenticationProviderClass<any> {
  ...
  async connectWithProvider(options:any ): Promise<any> {
    return 5 as any;
    ...
    // };
    //
    // return await this.authenticate(payload, 'redirect');
  }
}
