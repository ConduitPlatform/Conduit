...
export const getAuthUsersData = (page, limit) => {
  return (dispatch) => {
    dispatch(startAuthUsersLoading());
    getAuthUsersDataReq(page, limit)
      .then((res) => {
...
export const searchUsersThunk = (values) => {
  return (dispatch) => {
    searchUser(values)
      .then((res) => dispatch(searchUsers(values)))
...
export const deleteUserThunk = (id) => {
  return async (dispatch) => {
    ...
    // await deleteUser(id);
    // console.log('Hi 2');
    // await dispatch(getAuthUsersData(0, 10));
    // console.log('Hi 3');
    // dispatch(stopAuthUsersLoading());
    // dispatch(setAuthUsersError(null));
  };
