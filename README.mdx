...
| `SERVICE_RECONN_RETRIES` | Reconnection attempts before removal of unhealthy services (default: 5) |  False   | `5` |
| `SERVICE_RECONN_INIT_MS` | Initial delay for exponential backoff reconnection to unhealthy service in ms (default: 250) | False | `125` |
| `DEBUG__DISABLE_SERVICE_REMOVAL` | Prevent removal of inactive module services   | False    |    `true`   |
