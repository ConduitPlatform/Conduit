...
export class CoreBootstrapper {
  static bootstrap() {
    ...
    var packageDefinition = protoLoader.loadSync(path.resolve(__dirname, "./core.proto"), {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
  ...
  private static async bootstrapSdkComponents(
    ...
    if (error) {
      ...
      await app.conduit.getConfigManager().addFieldsToModule("core", convict.getProperties());
    }
